...
from game_information import (get_team_info, get_game_round, get_team_names, CURRENT_SEASON, CURRENT_GAME_WEEK,
                              ...
                              FREE_TRANSFERS, TRANSFER_COST, CHALLENGE_TEAM, CALIBRATE_BY, BUGGED_PLAYERS,
                              PROCESS_ALL_PLAYERS, USE_AVERAGE, TOTAL_PLAYERS, GKPs, DEFs, MIDs, FWDs, MAX_PER_TEAM,
...
if __name__ == "__main__":
    init(CURRENT_SEASON, CURRENT_GAME_WEEK, SEASON_LENGTH + 1 - CURRENT_GAME_WEEK, CHALLENGE_TEAM, CALIBRATE_BY,
